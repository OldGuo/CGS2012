...
public class RedBoss extends Boss{
	...
	public RedBoss (int x, int y) throws SlickException{
		super(x,y);
		addAnimation("RedBoss", new Animation(new SpriteSheet("data"+GameConstants.separatorChar+"CharAnim"+GameConstants.separatorChar+"RedBossWalking.png", 128, 128), 150));
